---
title: "101c_mid"
author: "Anshuman Mahalley and Catherine Jennifer"
date: "11/6/2020"
...
#QDA
QDAfit <- train(class ~ ., data = train1, method = "qda", preProcess = c("pca", "center", "scale"),
...
copy_test$class <- predict(LDAfit, newdata = copy_test)  #Assigning predicted outputs to 'class' column of copy_test dataframe
